package com.example.gayaak_10.videoplayer;
...
import com.example.gayaak_10.videoplayer.global.EnumAspectRatio;
import com.example.gayaak_10.videoplayer.global.EnumLoop;
import com.example.gayaak_10.videoplayer.global.EnumResizeMode;
import com.example.gayaak_10.videoplayer.player.utils.PublicFunctions;
import com.example.gayaak_10.videoplayer.player.utils.PublicValues;
...
public class AndExoPlayerViewWithoutControls extends LinearLayout implements View.OnClickListener {
    ...
    public class ComponentListener implements Player.EventListener {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            ...
            if (exoPlayerCallBack != null){
                exoPlayerCallBack.videoStatus(stateString);
            }
    ...
    public AndExoPlayerViewWithoutControls(Context context) {
        super(context);
        initializeView(context);
    }

    public AndExoPlayerViewWithoutControls(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public AndExoPlayerViewWithoutControls(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initializeView(Context context) {
        ...
        View view = inflater.inflate(R.layout.layout_player_base_without_controls, this, true);
        ...
        if (typedArray != null) {
            ...
            if (typedArray.hasValue(R.styleable.AndExoPlayerView_andexo_aspect_ratio)) {
                int aspectRatio = typedArray.getInteger(R.styleable.AndExoPlayerView_andexo_aspect_ratio, EnumAspectRatio.ASPECT_MATCH.getValue());
    ...
    private void initializePlayer() {
        ...
        if (simpleExoPlayer == null) {
            ...
            exoPlayerCallBack = new ExoPlayerCallBack() {
                @Override
                public void onError() {
