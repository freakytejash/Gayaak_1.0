...
public class AndExoPlayerView extends LinearLayout implements View.OnClickListener {
    ...
    private void enterFullScreen() {
        ...
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("screenOrientationEnterFull"));
    ...
    private void exitFullScreen() {
        ...
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("screenOrientationExitFull"));
        if (getActivity() != null)
