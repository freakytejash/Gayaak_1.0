...
public class TutorCourseVideoListAdapter extends RecyclerView.Adapter<TutorCourseVideoListAdapter.ViewHolder> {
    ...
    public TutorCourseVideoListAdapter(Context context, ArrayList<VideosModuleDataContractList> allCoursesDetail, OnItemClickListener onItemClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(VideosModuleDataContractList videoData, Context mContext, final OnItemClickListener onItemClickListener) {
            ...
            binding.ivVideoLock.setVisibility(View.GONE);
