...
public class TutorCourseCatalogAdapter extends RecyclerView.Adapter<TutorCourseCatalogAdapter.ViewHolder>  implements Filterable {
    ...
    public TutorCourseCatalogAdapter(Context context, List<CoursesDetail> detail, String moreCourses, OnItemClickListener onItemClickListener) {
