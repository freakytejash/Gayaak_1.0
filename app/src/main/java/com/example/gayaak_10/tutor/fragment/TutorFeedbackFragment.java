...
public class TutorFeedbackFragment extends Fragment implements View.OnClickListener {
    ...
    private void openCoursePopup(View view) {
        ...
        AllCoursesAdapter adapter = new AllCoursesAdapter(getActivity(), App.allCoursesArrayList, new AllCoursesAdapter.OnItemClickListener() {
            @Override
            public void onItemClickListener(int position) {
                popup.dismiss();
                selectedCourseId = App.allCoursesArrayList.get(position).courseId;
                binding.tvCourseRecommended.setText(App.allCoursesArrayList.get(position).name);
            }
        });
