...
public class LearnInterestAdapter extends RecyclerView.Adapter<LearnInterestAdapter.ViewHolder> {

    private Context context;
    private ArrayList<LearningLevelDataContractList> learningList;
    private OnItemClickListener onItemClickListener;

    public LearnInterestAdapter(Context context, ArrayList<LearningLevelDataContractList> learningList, OnItemClickListener onItemClickListener) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(LearningLevelDataContractList courseType, OnItemClickListener onItemClickListener) {
