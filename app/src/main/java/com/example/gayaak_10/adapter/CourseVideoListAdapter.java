...
public class CourseVideoListAdapter extends RecyclerView.Adapter<CourseVideoListAdapter.ViewHolder> {
    ...
    public CourseVideoListAdapter(Context context, ArrayList<VideoData> allCoursesDetail, OnItemClickListener onItemClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(VideoData videoData, Context mContext, final OnItemClickListener onItemClickListener) {
