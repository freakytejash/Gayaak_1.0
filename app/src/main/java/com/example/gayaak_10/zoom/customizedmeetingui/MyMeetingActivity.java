...
import com.example.gayaak_10.zoom.customizedmeetingui.audio.MeetingAudioCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.audio.MeetingAudioHelper;
import com.example.gayaak_10.zoom.customizedmeetingui.bo.BOEventCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.other.MeetingCommonCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import com.example.gayaak_10.zoom.customizedmeetingui.share.MeetingShareCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.share.MeetingShareHelper;
import com.example.gayaak_10.zoom.customizedmeetingui.user.MeetingUserCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.video.MeetingVideoCallback;
import com.example.gayaak_10.zoom.customizedmeetingui.video.MeetingVideoHelper;
import com.example.gayaak_10.zoom.customizedmeetingui.view.MeetingOptionBar;
import com.example.gayaak_10.zoom.customizedmeetingui.view.MeetingWindowHelper;
import com.example.gayaak_10.zoom.customizedmeetingui.view.RealNameAuthDialog;
import com.example.gayaak_10.zoom.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import com.example.gayaak_10.zoom.customizedmeetingui.view.share.CustomShareView;
import com.example.gayaak_10.zoom.ui.OpenZoomViewActivity;
import com.example.gayaak_10.zoom.ui.UIUtil;
...
public class MyMeetingActivity extends FragmentActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
  ...
  //  private AnnotateToolbar mDrawingView;
    ...
    private boolean finishWithFeedback = false;
    ...
    private void updateAttendeeVideos(List<Long> userlist, int action) {
        for (int i = 0; i < userlist.size(); i++) {
            Log.e("userId", "showVideoListLayout: "+userlist.get(i));
        }
        if (action == 0) {
    ...
    private void showMainActivity() {
        Class clz = OpenZoomViewActivity.class;
    ...
    private void showHomeActivity() {
        Class clz;
        switch (App.userDataContract.detail.roleId){
            case 3:
                clz = StudentHomeActivity.class;
                break;
            case 2:
                clz = TutorHomeActivity.class;
                break;
            default:
                clz = OpenZoomViewActivity.class;
        }

        Intent intent = new Intent(this, clz);
        intent.putExtra(Constant.ZOOM_SESSION_FINISHED, true);
    ...
    private void finishOpenFeedback() {
        if (finishWithFeedback){
            finishWithFeedback = false;
            finished = true;
            showHomeActivity();
        }
        ...
        if (mInMeetingService.isMeetingConnected()) {
            if (mInMeetingService.isMeetingHost()) {
                builder.setTitle("End or leave meeting")
                        .setPositiveButton("End", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (App.userDataContract.detail.roleId == 3){
                                    Log.e(TAG, "onClick: Student leave 1" );
                                }else {
                                    Log.e(TAG, "onClick: tutor leave 1" );
                                }
                                finishWithFeedback = true;
                                leave(true);
                            }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (App.userDataContract.detail.roleId == 3){
                            Log.e(TAG, "onClick: Student leave 2" );
                        }else {
                            Log.e(TAG, "onClick: tutor leave 2" );
                        }
                        finishWithFeedback = true;
                        leave(false);
                    }
                ...
                builder.setTitle("Leave meeting")
                        .setPositiveButton("Leave", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (App.userDataContract.detail.roleId == 3){
                                    Log.e(TAG, "onClick: Student leave 3" );
                                }else {
                                    Log.e(TAG, "onClick: tutor leave 3" );
                                }
                                finishWithFeedback = true;
                                leave(false);
            ...
            builder.setTitle("Leave meeting")
                    .setPositiveButton("Leave", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (App.userDataContract.detail.roleId == 3){
                                Log.e(TAG, "onClick: Student leave 4" );
                            }else {
                                Log.e(TAG, "onClick: tutor leave 4" );
                            }
                            finishWithFeedback = true;
                            leave(false);
                        }
    ...
    private void attendeeRequestHelp() {
        ...
        if (boAttendee != null) {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Ask for Help", (dialog, which) -> boAttendee.requestForHelp()).create().show();
        }
    }
