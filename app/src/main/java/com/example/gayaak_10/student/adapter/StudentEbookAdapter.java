...
public class StudentEbookAdapter extends RecyclerView.Adapter<StudentEbookAdapter.ViewHolder> {
    ...
    public StudentEbookAdapter(Context context, ArrayList<PDFModuleDataContractList> detail, OnItemClickListener onItemClickListener) {
