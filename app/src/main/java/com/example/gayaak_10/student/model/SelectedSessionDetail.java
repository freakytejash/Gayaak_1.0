...
public class SelectedSessionDetail{
    ...
    public SelectedSessionDetail(String courseName, Integer courseId, Integer coursePrice, Integer courseSessions, String courseSelectedDay, String courseSelectedTime, Integer tutorId, Integer tutorScheduleId, Integer levelId, Integer studentTutorBookingId, Integer scheduleId, Integer categoryId) {
