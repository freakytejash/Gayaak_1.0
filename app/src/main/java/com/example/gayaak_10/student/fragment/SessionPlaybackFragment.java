...
public class SessionPlaybackFragment extends DialogFragment {

    private static final String LOG_TAG = "PlaybackFragment";

    private static final String ARG_ITEM = "recording_item";
    private PractiseSessionInfoDetail item;
    ...
    private AppCompatImageView mPlayButton = null;
 ...
 //   long seconds = 0;
    ...
    public SessionPlaybackFragment newInstance(PractiseSessionInfoDetail item) {
        SessionPlaybackFragment f = new SessionPlaybackFragment();
        Bundle b = new Bundle();
...
//        retriever.setDataSource(item.audioFileName);
...
//                - TimeUnit.MINUTES.toSeconds(minutes);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mPlayButton = (AppCompatImageView) view.findViewById(R.id.fab_play);
        ...
        mFileNameTextView.setText(item.comment);
    ...
    private void startPlaying() {
        ...
        try {
            mMediaPlayer.setDataSource(item.audioFileName);
